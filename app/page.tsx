  ...
  return (
    <main className="reference-site">
      ...
      <style jsx global>{`
        ...
        .site-section{scroll-margin-top:96px}.token-section{scroll-margin-top:96px;min-height:auto!important;height:auto!important;padding:34px 0 40px!important}.tokenomics-reference-image-wrap{height:auto!important;min-height:0!important;aspect-ratio:16/9!important}.tokenomics-reference-image{height:auto!important;width:100%!important;object-fit:contain!important;object-position:center top!important}.roadmap-section{position:relative;isolation:isolate;overflow:visible;min-height:calc(100vh - 84px);padding:28px 0 34px!important;background:radial-gradient(circle at 50% 8%,rgba(50,224,255,.13),transparent 30%),radial-gradient(circle at 8% 58%,rgba(107,76,255,.10),transparent 28%),radial-gradient(circle at 92% 78%,rgba(255,67,198,.08),transparent 28%),#020918!important}
