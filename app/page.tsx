  ...
  return (
    <main className="reference-site" data-view={activeView}>
      ...
      <style jsx global>{`
        ...
        .roadmap-section{position:relative;isolation:isolate;overflow:visible;min-height:calc(100vh - 84px);padding:72px 0 82px!important;background:radial-gradient(circle at 50% 8%,rgba(50,224,255,.13),transparent 30%),radial-gradient(circle at 8% 58%,rgba(107,76,255,.10),transparent 28%),radial-gradient(circle at 92% 78%,rgba(255,67,198,.08),transparent 28%),#020918!important}
        ...
        .roadmap-grid.crypto-roadmap-grid{grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:14px!important;margin-top:42px!important}
        ...
        .roadmap-crypto-icon{width:64px;height:64px;margin:22px 0 20px;border-radius:22px;position:relative;z-index:2;font-size:30px;background:radial-gradient(circle at 35% 25%,rgba(65,229,255,.28),rgba(7,18,42,.78) 68%);box-shadow:0 0 34px rgba(45,206,255,.14),inset 0 0 24px rgba(60,215,255,.07)}
        ...
        .crypto-roadmap-card h3{margin:0!important;position:relative;z-index:2;font-size:25px!important;letter-spacing:-.03em}.crypto-roadmap-card p{position:relative;z-index:2;font-size:13px;line-height:1.72;margin:14px 0 0;color:#8fa1bb!important;max-width:30ch}
        ...
        @media(max-width:1050px){.roadmap-section{min-height:auto;padding:82px 0!important}.roadmap-grid.crypto-roadmap-grid{grid-template-columns:repeat(2,1fr)!important}.crypto-roadmap-grid::before{display:none}.crypto-roadmap-card{min-height:320px!important}}
        @media(max-width:650px){.roadmap-section{padding:70px 0!important}.roadmap-grid.crypto-roadmap-grid{grid-template-columns:1fr!important;gap:14px!important}.crypto-roadmap-card{min-height:300px!important;padding:20px!important}.roadmap-crypto-icon{margin:22px 0 18px}.crypto-roadmap-card p{max-width:none}}
      `}</style>
      <Hero />
