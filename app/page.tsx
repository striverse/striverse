  ...
  return (
    <main className="reference-site">
      ...
      <style jsx global>{`
        ...
        .roadmap-crypto-icon{width:72px;height:72px;margin:38px 0 24px;border-radius:22px;position:relative;z-index:2;font-size:30px;background:radial-gradient(circle at 35% 25%,rgba(65,229,255,.28),rgba(7,18,42,.78) 68%);box-shadow:0 0 34px rgba(45,206,255,.14),inset 0 0 24px rgba(60,215,255,.07)}
        ...
        .crypto-roadmap-card h3{margin:0!important;position:relative;z-index:2;font-size:28px!important;letter-spacing:-.03em}.crypto-roadmap-card p{position:relative;z-index:2;font-size:13px;line-height:1.72;margin:14px 0 0;color:#8fa1bb!important;max-width:30ch}
        ...
        @media(max-width:1050px){.roadmap-grid.crypto-roadmap-grid{grid-template-columns:repeat(2,1fr)!important}.crypto-roadmap-grid::before{display:none}.crypto-roadmap-card{min-height:350px!important}}
        @media(max-width:650px){.roadmap-grid.crypto-roadmap-grid{grid-template-columns:1fr!important;gap:14px!important}.crypto-roadmap-card{min-height:330px!important;padding:20px!important}.roadmap-crypto-icon{margin:28px 0 20px}.crypto-roadmap-card p{max-width:none}}
      `}</style>
      <Hero />
