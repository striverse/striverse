...
export default function Hero() {
  ...
  return (
    <section className="reference-hero-live" aria-label="STRIVERSE landing page">
      ...
      <div className="reference-nebula reference-nebula-a" />
      <div className="reference-nebula reference-nebula-b" />
      <div className="reference-hero-art" aria-hidden="true" />

      <div className="reference-planet">
        <div className="reference-planet-glow" />
        <div className="reference-planet-surface" />
        <div className="reference-planet-light" />
      </div>
      <div className="reference-moon" />

      <div className="reference-mountain mountain-a" />
      <div className="reference-mountain mountain-b" />
      <div className="reference-mountain mountain-c" />
      <div className="reference-platform">
        <div className="platform-ring platform-ring-a" />
        <div className="platform-ring platform-ring-b" />
        <div className="platform-core" />
      </div>
      <div className="reference-light-beam beam-a" />
      <div className="reference-light-beam beam-b" />
      <div className="reference-light-beam beam-c" />
      ...
      <div className="reference-hero-content">
        <div className="reference-hero-copy">
          ...
          <h1>
            Secure, Smart, and
            <br />
            Limitless! <span>Join</span>
            <br />
            <span>STRIVERSE</span>
          </h1>
          <p className="reference-lead">
            Explore a next-generation ecosystem built around STV,
            <br className="desktop-break" />
            with investing, staking, vesting, airdrops, and a connected
            <br className="desktop-break" />
            community — all in one place.
          </p>

          <div className="reference-hero-actions">
            <Link href="/register" className="reference-primary-cta">
              Explore STRIVERSE <span>↗</span>
            </Link>
            <a href="#invest" className="reference-video-cta">
              <span className="reference-play"><PlayCircle size={18} strokeWidth={1.7} /></span>
              Watch Video
            </a>
          </div>
          ...
          <div className="reference-stats">
            ...
            <div className="reference-stat">
              ...
              <div><b>${formatNumber(stats.raised)}</b><small>Raised</small></div>
            </div>
            <div className="reference-stat">
      ...
      <div className="reference-hero-scroll">
        <span />
        <b>⌄</b>
      </div>
    </section>
